...
* **自动NoShow变为手工NoShow，可及时释放库存：**酒店可以在入住日当日23：00~次日6：00之间，对未到店的客人标记NoShow
* **可实现订单的部分取消/NoShow**
* **夜审时所有待入住订单变更为入住**：系统标记操作人为“PMS系统“，计入URN
* **申诉流程简化、新增申诉原因：**可以满足订单状态错误/信息错误/价格错误等多种类型的申诉
...
* 对系统自动入住、客人实际到店的订单补排房，保证房态准确。并补入住人信息
